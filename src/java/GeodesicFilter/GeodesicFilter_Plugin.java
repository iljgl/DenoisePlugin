package org.oxh.GeodesicFilter;
...
import org.oxh.GeodesicFilter.Core.GeodesicFilterCore;
...
public class GeodesicFilter_Plugin implements PlugIn {
    ...
    private ImagePlus processSingleFrame(ImagePlus imp, int W, double alpha, double sigma) {
        ...
        return createResultImage(filtered, imp.getTitle(), w, h, recordMax, "_GeoFilter.tif");
    }
